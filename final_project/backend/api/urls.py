...
from .views import ArticleData,ShopItemData,CartItemData,SalesOrderData,ArticleDelete,ArticleCreate,CommentData,CommentCreate
urlpatterns = [
    ...
    path("article/comment/new/", CommentCreate.as_view(), name="comment_new"),
